<template>
  <DefineContent>
    <div class="space-y-3 p-4">
      <!-- Economy -->
      <div v-if="settings.economy" class="text-sm">
      ...
      <div class="grid grid-cols-2 gap-4 text-sm">
        <div class="flex items-center space-x-2">
          ...
          <Badge :variant="settings.disasters ? 'default' : 'secondary'" class="text-xs">
        ...
        <div class="flex items-center space-x-2">
          ...
          <Badge :variant="settings.breakdowns ? 'default' : 'secondary'" class="text-xs">
        ...
        <div class="flex items-center space-x-2">
          ...
          <Badge :variant="settings.inflation ? 'default' : 'secondary'" class="text-xs">
        ...
        <div class="flex items-center space-x-2">
          ...
          <Badge :variant="settings.seasons ? 'default' : 'secondary'" class="text-xs">
      ...
      <!-- Comment -->
      <div v-if="settings.comment" class="text-sm">
  ...
  <Card v-if="!asPartial" class="game-settings-card hover:shadow-lg transition-shadow duration-200">
    <CardContent>
      <Content />
    </CardContent>
  </Card>
