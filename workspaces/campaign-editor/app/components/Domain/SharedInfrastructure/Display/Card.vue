<template>
  <DefineContent>
    <div class="space-y-3 p-4">
      <!-- Track -->
      <div
        v-if="sharedInfrastructure.track"
        class="text-sm"
      >
      ...
      <div class="grid grid-cols-2 gap-4 text-sm">
        <div class="flex items-center space-x-2">
          ...
          <Badge
            :variant="sharedInfrastructure.stations ? 'default' : 'secondary'"
            class="text-xs"
          >
        ...
        <div class="flex items-center space-x-2">
          ...
          <Badge
            :variant="sharedInfrastructure.vehicles ? 'default' : 'secondary'"
            class="text-xs"
          >
        ...
        <div class="flex items-center space-x-2">
          ...
          <Badge
            :variant="sharedInfrastructure.depots ? 'default' : 'secondary'"
            class="text-xs"
          >
      ...
      <!-- Comment -->
      <div
        v-if="sharedInfrastructure.comment"
        class="text-sm"
      >
  ...
  <Card
    v-if="!asPartial"
    class="shared-infrastructure-card hover:shadow-lg transition-shadow duration-200"
  >
    <CardContent>
      <Content />
    </CardContent>
