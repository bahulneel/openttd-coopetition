<template>
  <DefineContent>
    <div class="space-y-3 p-4">
      ...
      <div class="flex items-center justify-between">
        ...
        <div v-if="scenarioGoal.branch" class="text-sm text-muted-foreground">
  ...
  <Card v-if="!asPartial" class="scenario-goal-card hover:shadow-lg transition-shadow duration-200">
    <CardContent>
      <Content />
    </CardContent>
  </Card>
