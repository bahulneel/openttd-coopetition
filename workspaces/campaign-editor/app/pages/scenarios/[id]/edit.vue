...
id="estimated_time" v-model="form.meta!.estimated_time" placeholder="e.g., 2 hours"
          ...
          <div class="space-y-4">
            ...
            <div v-else class="space-y-3">
              <div
v-for="goal in availableGoals" :key="entityId(goal)"
                class="flex items-center space-x-3 p-3 border rounded-lg">
                <input
:id="`goal-${entityId(goal)}`" v-model="selectedGoals" :value="entityId(goal)" type="checkbox"
...
id="max_date" v-model.number="form.constraints!.date!.max" type="number" placeholder="e.g., 2050"
          ...
          <!-- Game Settings -->
          <DomainGameSettingsInput v-model:settings="form.settings!" />
